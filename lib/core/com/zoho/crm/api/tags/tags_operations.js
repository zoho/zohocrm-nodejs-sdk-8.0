...
class TagsOperations{
	 ...
	 * @throws {SDKException}
	 */
	async addTags(moduleAPIName, recordId, request, paramInstance=null)	{
	 ...
	 * @throws {SDKException}
	 */
	async removeTags(moduleAPIName, recordId, request)	{
...
class GetTagsParam{
	...
	static INCLUDE = new Param("include", "com.zoho.crm.api.Tags.GetTagsParam");
}

class CreateTagsParam{

	static MODULE = new Param("module", "com.zoho.crm.api.Tags.CreateTagsParam");
	static COLOR_CODE = new Param("color_code", "com.zoho.crm.api.Tags.CreateTagsParam");
}
