...
class UpdateWebForms {
    ...
    static async updateWenForms(moduleAPIName) {
        ...
        let response = await webformsOperations.updateWebForms(request);
        if (response != null) {
...
await UpdateWebForms.initialize();
await UpdateWebForms.updateWenForms(moduleAPIName);