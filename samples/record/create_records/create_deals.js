...
class CreateDeals {
    ...
    static async createDeals(moduleAPIName) {
        ...
        accountName.setId(4402480001390054n);
        ...
        contactName.setId(4402480001393062n);
        ...
        campaign_source.setId(4402480001393057n);
...
await CreateDeals.initialize();
await CreateDeals.createDeals(moduleAPIName);