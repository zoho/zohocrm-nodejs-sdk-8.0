...
class UpdateCalls {
    ...
    static async updateCalls(moduleAPIName) {
        ...
        await record1.addFieldValue(ZOHOCRMSDK.Record.Field.Calls.CALL_RESULT, new ZOHOCRMSDK.Choice("Not interested"));
        ...
        let user2 = new ZOHOCRMSDK.Users.MinifiedUser();
        user2.setId(4323001232n);
        record1.addKeyValue("User_1", user2);
        // for Custom LookUp
...
await UpdateCalls.initialize();
await UpdateCalls.updateCalls(moduleAPIName);