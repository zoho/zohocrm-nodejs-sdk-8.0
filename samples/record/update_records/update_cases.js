...
class UpdateCases {
    ...
    static async updateCases(moduleAPIName) {
        ...
        let response = recordOperations.updateRecords(request, headerInstance);
        if (response != null) {
...
await UpdateCases.initialize();
await UpdateCases.updateCases(moduleAPIName);