...
class UpdateGlobalPicklists {
	...
	static async updateGlobalPicklists() {
		...
		let response = await globalPicklistsOperations.updateGlobalPicklists(bodyWrapper);
		if (response != null) {
...
await UpdateGlobalPicklists.initialize();
await UpdateGlobalPicklists.updateGlobalPicklists();