...
class UpdateScoringRule {
    ...
    static async updateScoringRule(id) {
        ...
        let response = await scoringRulesOperations.updateScoringRule(id, bodyWrapper);
...
let id = 66539000431019n;
await UpdateScoringRule.initialize();
await UpdateScoringRule.updateScoringRule(id);