...
class ActivateSharingRule{
    ...
    static async activateSharingRule(id, moduleAPIName) {
        const sharingRulesOperations = new ZOHOCRMSDK.SharingRules.SharingRulesOperations(moduleAPIName);

        // Call the API method
        const response = await sharingRulesOperations.activateSharingRule(id);
...
await ActivateSharingRule.initialize();
await ActivateSharingRule.activateSharingRule(id, moduleAPIName);