...
class DeassociateTerritoryUser {
    ...
    static async deAssociateTerritoryUser(user, territory) {
        let territoryUsersOperations = new ZOHOCRMSDK.TerritoryUsers.TerritoryUsersOperations();
        let response = await territoryUsersOperations.deassociateTerritoryUser(user, territory);
        if (response != null) {
...
let territory = 440241390040n;
let user = 440248054001n;
await DeassociateTerritoryUser.initialize();
await DeassociateTerritoryUser.deAssociateTerritoryUser(user, territory);