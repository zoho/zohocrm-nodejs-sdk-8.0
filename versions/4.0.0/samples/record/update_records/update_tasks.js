...
class UpdateTasks {
    ...
    static async updateTasks(moduleAPIName) {
...
let moduleAPIName = "Tasks";
await UpdateTasks.initialize();
await UpdateTasks.updateTasks(moduleAPIName);