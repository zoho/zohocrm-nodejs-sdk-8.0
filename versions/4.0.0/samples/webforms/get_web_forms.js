...
class GetWebForms {
    ...
    static async getWebForms(moduleAPIName) {
        let webformsOperations = new ZOHOCRMSDK.Webforms.WebformsOperations(moduleAPIName);
        let response = await webformsOperations.getWebForms();
        if (response != null) {
            ...
            if (responseHandler instanceof ResponseWrapper) {
                ...
                for (let webform in webforms) {
                    ...
                    let formFields = webform.getFields();
                    if (formFields != null) {
...
await GetWebForms.initialize();
await GetWebForms.getWebForms(moduleAPIName);
