...
class UpdateVariableByIDParam{
	...
	static GROUP = new Param("group", "com.zoho.crm.api.Variables.UpdateVariableByIDParam");
}

class UpdateVariableByAPINameParam{

	static GROUP = new Param("group", "com.zoho.crm.api.Variables.UpdateVariableByAPINameParam");
}

class GetVariableByAPINameParam{

	static GROUP = new Param("group", "com.zoho.crm.api.Variables.GetVariableByAPINameParam");
}
