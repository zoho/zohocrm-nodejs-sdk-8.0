...
class GetUsersUnavailabilityParam{
	...
	static INCLUDE_INNER_DETAILS = new Param("include_inner_details", "com.zoho.crm.api.UsersUnavailability.GetUsersUnavailabilityParam");
	static GROUP_IDS = new Param("group_ids", "com.zoho.crm.api.UsersUnavailability.GetUsersUnavailabilityParam");
	static ROLE_IDS = new Param("role_ids", "com.zoho.crm.api.UsersUnavailability.GetUsersUnavailabilityParam");
	static TERRITORY_IDS = new Param("territory_ids", "com.zoho.crm.api.UsersUnavailability.GetUsersUnavailabilityParam");
	static FILTERS = new Param("filters", "com.zoho.crm.api.UsersUnavailability.GetUsersUnavailabilityParam");
}

class GetUserUnavailabilityParam{

	static INCLUDE_INNER_DETAILS = new Param("include_inner_details", "com.zoho.crm.api.UsersUnavailability.GetUserUnavailabilityParam");
	static FILTERS = new Param("filters", "com.zoho.crm.api.UsersUnavailability.GetUserUnavailabilityParam");
}
