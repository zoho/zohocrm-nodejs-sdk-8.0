...
class ProcessInfo{
	 ...
	 * @returns {BigInt} A BigInt representing the fieldId
	 */
	getFieldId()	{
		return this.fieldId;
	 ...
	 */
	async setEscalation(escalation)	{
		const Escalation = (await (import("./escalation.js"))).MasterModel;
	 ...
	 */
	async setCurrentPicklist(currentPicklist)	{
		const CurrentPicklist = (await (import("./current_picklist.js"))).MasterModel;
		if((currentPicklist != null) && (!(currentPicklist instanceof CurrentPicklist)))	{
