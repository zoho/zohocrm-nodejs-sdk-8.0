...
class FormAttributes{
	 ...
	 * @returns {Logo} An instance of Logo
	 */
	getLogo()	{
		return this.logo;
	 ...
	 */
	async setLogo(logo)	{
		const Logo = (await (import("./logo.js"))).MasterModel;
		if((logo != null) && (!(logo instanceof Logo)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: logo EXPECTED TYPE: Logo", null, null);
		}
		this.logo = logo;
	 ...
	 * @returns {Background} An instance of Background
	 */
	getBackground()	{
	...
	async setBackground(background)	{
		const Background = (await (import("./background.js"))).MasterModel;
		if((background != null) && (!(background instanceof Background)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: background EXPECTED TYPE: Background", null, null);
		}
	 ...
	 * @returns {Boolean} A Boolean representing the displayFormName
	 */
	getDisplayFormName()	{
	 ...
	 * @param {Boolean} displayFormName A Boolean representing the displayFormName
	 */
	setDisplayFormName(displayFormName)	{
		if((displayFormName != null) && (!(Object.prototype.toString.call(displayFormName) == "[object Boolean]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: displayFormName EXPECTED TYPE: Boolean", null, null);
		}
