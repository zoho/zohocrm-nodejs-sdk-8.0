...
class AcknowledgeVisitor{
	 ...
	 */
	async setReplyToAddress(replyToAddress)	{
		const FromAddress = (await (import("./from_address.js"))).MasterModel;
		if((replyToAddress != null) && (!(replyToAddress instanceof FromAddress)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: replyToAddress EXPECTED TYPE: FromAddress", null, null);
		}
	 ...
	 * @returns {String} A String representing the templateId
	 */
	getTemplateId()	{
	 ...
	 * @param {String} templateId A String representing the templateId
	 */
	setTemplateId(templateId)	{
		if((templateId != null) && (!(Object.prototype.toString.call(templateId) == "[object String]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: templateId EXPECTED TYPE: String", null, null);
		}
