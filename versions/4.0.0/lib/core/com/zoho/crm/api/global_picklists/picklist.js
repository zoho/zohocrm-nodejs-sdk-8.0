...
class Picklist{
	 ...
	 * @returns {number} A number representing the associatedFieldsCount
	 */
	 ...
	 * @param {number} associatedFieldsCount A number representing the associatedFieldsCount
	 */
	setAssociatedFieldsCount(associatedFieldsCount)	{
		if((associatedFieldsCount != null) && (!(Object.prototype.toString.call(associatedFieldsCount) == "[object Number]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: associatedFieldsCount EXPECTED TYPE: number", null, null);
		}
	 ...
	 * @returns {Array} An Array representing the usedInModules
	 */
	getUsedInModules()	{
	 ...
	 * @param {Array} usedInModules An Array representing the usedInModules
	 */
