...
class MassDeleteTagsOperations{
	...
	async getStatus(paramInstance=null)	{
		...
		const require = createRequire(import.meta.url);
		let StatusResponseHandler = require.resolve("./status_response_handler.js");
		return handlerInstance.apiCall(StatusResponseHandler, "application/json");
...
class GetStatusParam{
	...
	static JOB_ID = new Param("job_id", "com.zoho.crm.api.MassDeleteTags.GetStatusParam");
}
