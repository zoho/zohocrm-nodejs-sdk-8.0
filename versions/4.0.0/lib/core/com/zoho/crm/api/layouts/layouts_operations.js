...
class LayoutsOperations{
	 ...
	 * @throws {SDKException}
	 */
	async updateCustomLayout(id, request, paramInstance=null)	{
	 ...
	 * @throws {SDKException}
	 */
	async deleteCustomLayout(id, paramInstance=null)	{
		if((!(Object.prototype.toString.call(id) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: id EXPECTED TYPE: BigInt", null, null);
		}
		if((paramInstance != null) && (!(paramInstance instanceof ParameterMap)))	{
	 ...
	 * @throws {SDKException}
	 */
	async activateCustomLayout(id, request, paramInstance=null)	{
		const BodyWrapper = (await (import("./body_wrapper.js"))).MasterModel;
		if((!(Object.prototype.toString.call(id) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: id EXPECTED TYPE: BigInt", null, null);
		}
	 ...
	 * @throws {SDKException}
	 */
	async deactivateCustomLayout(id, paramInstance=null)	{
		if((!(Object.prototype.toString.call(id) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: id EXPECTED TYPE: BigInt", null, null);
		}
		if((paramInstance != null) && (!(paramInstance instanceof ParameterMap)))	{
...
class UpdateCustomLayoutParam{
	...
	static MODULE = new Param("module", "com.zoho.crm.api.Layouts.UpdateCustomLayoutParam");
}

class DeleteCustomLayoutParam{

	static MODULE = new Param("module", "com.zoho.crm.api.Layouts.DeleteCustomLayoutParam");
	static TRANSFER_TO = new Param("transfer_to", "com.zoho.crm.api.Layouts.DeleteCustomLayoutParam");
}

class ActivateCustomLayoutParam{

	static MODULE = new Param("module", "com.zoho.crm.api.Layouts.ActivateCustomLayoutParam");
}

class DeactivateCustomLayoutParam{

	static TRANSFER_TO = new Param("transfer_to", "com.zoho.crm.api.Layouts.DeactivateCustomLayoutParam");
	static MODULE = new Param("module", "com.zoho.crm.api.Layouts.DeactivateCustomLayoutParam");
}
