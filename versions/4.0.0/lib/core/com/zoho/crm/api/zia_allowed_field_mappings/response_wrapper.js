...
class ResponseWrapper{
	 ...
	 */
	async setAllowedFieldMappings(allowedFieldMappings)	{
		const AllowedFieldMap = (await (import("./allowed_field_map.js"))).MasterModel;
		if((allowedFieldMappings != null) && (!(allowedFieldMappings instanceof AllowedFieldMap)))	{
