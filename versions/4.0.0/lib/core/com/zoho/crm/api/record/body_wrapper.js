...
class BodyWrapper{
	...
	applyValidationRule;
	applyFunctionValidationRule;
	skipFeatureExecution;
	keyModified = new Map();
	/**
	 ...
	 * @returns {String} A String representing the applyValidationRule
	 */
	 ...
	 * @param {String} applyValidationRule A String representing the applyValidationRule
	 */
	setApplyValidationRule(applyValidationRule)	{
		if((applyValidationRule != null) && (!(Object.prototype.toString.call(applyValidationRule) == "[object String]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: applyValidationRule EXPECTED TYPE: String", null, null);
		}
	 ...
	 * @returns {String} A String representing the applyFunctionValidationRule
	 */
	 ...
	 * @param {String} applyFunctionValidationRule A String representing the applyFunctionValidationRule
	 */
	setApplyFunctionValidationRule(applyFunctionValidationRule)	{
		if((applyFunctionValidationRule != null) && (!(Object.prototype.toString.call(applyFunctionValidationRule) == "[object String]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: applyFunctionValidationRule EXPECTED TYPE: String", null, null);
		}
	 ...
	 * @returns {Array} An Array representing the skipFeatureExecution
	 */
	 ...
	 * @param {Array} skipFeatureExecution An Array representing the skipFeatureExecution
	 */
	setSkipFeatureExecution(skipFeatureExecution)	{
		if((skipFeatureExecution != null) && (!(Object.prototype.toString.call(skipFeatureExecution) == "[object Array]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: skipFeatureExecution EXPECTED TYPE: Array", null, null);
		}
