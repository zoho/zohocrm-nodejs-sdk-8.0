...
class GetRecordLockingInformationsParam{
	...
	static PAGE_TOKEN = new Param("page_token", "com.zoho.crm.api.RecordLocking.GetRecordLockingInformationsParam");
	static PAGE = new Param("page", "com.zoho.crm.api.RecordLocking.GetRecordLockingInformationsParam");
	static PER_PAGE = new Param("per_page", "com.zoho.crm.api.RecordLocking.GetRecordLockingInformationsParam");
