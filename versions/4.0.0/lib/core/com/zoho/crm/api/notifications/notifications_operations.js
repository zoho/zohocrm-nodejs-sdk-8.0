...
class GetNotificationsParam{
	...
	static PAGE = new Param("page", "com.zoho.crm.api.Notifications.GetNotificationsParam");
	static PER_PAGE = new Param("per_page", "com.zoho.crm.api.Notifications.GetNotificationsParam");
	static CHANNEL_ID = new Param("channel_id", "com.zoho.crm.api.Notifications.GetNotificationsParam");
	static MODULE = new Param("module", "com.zoho.crm.api.Notifications.GetNotificationsParam");
}

class DeleteNotificationParam{

	static CHANNEL_IDS = new Param("channel_ids", "com.zoho.crm.api.Notifications.DeleteNotificationParam");
}
