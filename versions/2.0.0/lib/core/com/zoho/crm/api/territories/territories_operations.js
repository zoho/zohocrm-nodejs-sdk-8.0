...
class TerritoriesOperations{
	...
	async transferAndDeleteTerritory(id, request)	{
		const TransferBodyWrapper = (await (import("./transfer_body_wrapper.js"))).MasterModel;
		if((!(Object.prototype.toString.call(id) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: id EXPECTED TYPE: BigInt", null, null);
		}
...
class GetTerritoriesParam{
	...
	static FILTERS = new Param("filters", "com.zoho.crm.api.Territories.GetTerritoriesParam");
	static INCLUDE = new Param("include", "com.zoho.crm.api.Territories.GetTerritoriesParam");
	static PAGE = new Param("page", "com.zoho.crm.api.Territories.GetTerritoriesParam");
	static PER_PAGE = new Param("per_page", "com.zoho.crm.api.Territories.GetTerritoriesParam");
	static IDS = new Param("ids", "com.zoho.crm.api.Territories.GetTerritoriesParam");
}

class DeleteTerritoriesParam{

	static IDS = new Param("ids", "com.zoho.crm.api.Territories.DeleteTerritoriesParam");
	static DELETE_PREVIOUS_FORECASTS = new Param("delete_previous_forecasts", "com.zoho.crm.api.Territories.DeleteTerritoriesParam");
}

class DeleteTerritoryParam{

	static DELETE_PREVIOUS_FORECASTS = new Param("delete_previous_forecasts", "com.zoho.crm.api.Territories.DeleteTerritoryParam");
}

class GetChildTerritoryParam{

	static FILTERS = new Param("filters", "com.zoho.crm.api.Territories.GetChildTerritoryParam");
	static PAGE = new Param("page", "com.zoho.crm.api.Territories.GetChildTerritoryParam");
	static PER_PAGE = new Param("per_page", "com.zoho.crm.api.Territories.GetChildTerritoryParam");
}
