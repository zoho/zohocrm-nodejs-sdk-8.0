...
class SectionField extends Fields{
	 ...
	 */
	async setAutoNumber71(autoNumber71)	{
		const AutoNumber = (await (import("../fields/auto_number.js"))).MasterModel;
		if((autoNumber71 != null) && (!(autoNumber71 instanceof AutoNumber)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: autoNumber71 EXPECTED TYPE: AutoNumber", null, null);
		}
