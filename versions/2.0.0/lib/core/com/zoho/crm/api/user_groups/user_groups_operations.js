...
class UserGroupsOperations{
	 ...
	 * @throws {SDKException}
	 */
	async getAssociatedUsersCount(paramInstance=null)	{
		if((paramInstance != null) && (!(paramInstance instanceof ParameterMap)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: paramInstance EXPECTED TYPE: ParameterMap", null, null);
		}
		var handlerInstance = new CommonAPIHandler();
	 ...
	 * @throws {SDKException}
	 */
	async getAssociateGroupsOfUser(user, paramInstance=null)	{
...
class GetGroupsParam{
	...
	static FILTERS = new Param("filters", "com.zoho.crm.api.UserGroups.GetGroupsParam");
}
...
class GetAssociatedUsersCountParam{
	...
	static PAGE = new Param("page", "com.zoho.crm.api.UserGroups.GetAssociatedUsersCountParam");
	static PER_PAGE = new Param("per_page", "com.zoho.crm.api.UserGroups.GetAssociatedUsersCountParam");
	static FILTERS = new Param("filters", "com.zoho.crm.api.UserGroups.GetAssociatedUsersCountParam");
}

class GetAssociateGroupsOfUserParam{

	static INCLUDE = new Param("include", "com.zoho.crm.api.UserGroups.GetAssociateGroupsOfUserParam");
	static PAGE = new Param("page", "com.zoho.crm.api.UserGroups.GetAssociateGroupsOfUserParam");
	static PER_PAGE = new Param("per_page", "com.zoho.crm.api.UserGroups.GetAssociateGroupsOfUserParam");
}

class GetGroupedCountsParam{

	static GROUP_BY = new Param("group_by", "com.zoho.crm.api.UserGroups.GetGroupedCountsParam");
}
