...
class DeletRole {
    ...
    static async deleteRole(id) {
        ...
        await paraminstance.add(ZOHOCRMSDK.Roles.DeleteRoleParam.TRANSFER_TO_ID, 665390031154n);
        let response = await rolesOperations.deleteRole(id, paraminstance);
        if (response != null) {
...
let id = 66539000389009n;
await DeletRole.initialize();
await DeletRole.deleteRole(id);