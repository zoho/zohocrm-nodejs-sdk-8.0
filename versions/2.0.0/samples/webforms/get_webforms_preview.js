...
class GetWebformsPreview {
    ...
    static async getWebFormsPreview(moduleAPIName, formId) {
        let webformsOperations = new ZOHOCRMSDK.Webforms.WebformsOperations(moduleAPIName);
        let response = await webformsOperations.getWebformsPreview(formId);
        if (response != null) {
...
let formId = 32312131221n;
let moduleAPIName = "Leads";
await GetWebformsPreview.initialize();
await GetWebformsPreview.getWebFormsPreview(moduleAPIName, formId);