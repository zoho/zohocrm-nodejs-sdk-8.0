...
class DeleteAppointmentsRescheduledHistory {
    ...
    static async deleteAppointmentsRescheduledHistory(id) {
        let rescheduleHistoryOperations = new ZOHOCRMSDK.RescheduleHistory.RescheduleHistoryOperations();
        let response = await rescheduleHistoryOperations.deleteAppointmentsRescheduledHistory(id);
        if (response != null) {
...
let id = 66539000431047n;
await DeleteAppointmentsRescheduledHistory.initialize();
await DeleteAppointmentsRescheduledHistory.deleteAppointmentsRescheduledHistory(id)