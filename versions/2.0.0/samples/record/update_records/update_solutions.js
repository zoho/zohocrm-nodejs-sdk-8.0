...
class UpdateSolutions {
    ...
    static async updateSolutions(moduleAPIName) {
        ...
        productName.setId(44024801391082n);
        await productName.addFieldValue(ZOHOCRMSDK.Record.Field.Solutions.PRODUCT_NAME, productName);
        let solutionOwner = new ZOHOCRMSDK.Users.Users();
        solutionOwner.setId(4402480254001n);
...
let moduleAPIName = "Solutions";
await UpdateSolutions.initialize();
await UpdateSolutions.updateSolutions(moduleAPIName);