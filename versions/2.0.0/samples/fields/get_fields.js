            ...
            if (responseObject != null) {
                if (responseObject instanceof ZOHOCRMSDK.Fields.ResponseWrapper) {
                    ...
                    fields.forEach(field => {
                        ...
                        console.log("Field HistoryTrackingEnabled: " + field.getHistoryTrackingEnabled());
                        ...
                        if (field.getHistoryTracking() != null) {
                            ...
                            console.log("Field HistoryTracking RelatedListName:", historyTracking.getRelatedListName());
                            console.log(
                                "Field HistoryTracking DurationConfiguration:",
                                historyTracking.getDurationConfiguration() ? historyTracking.getDurationConfiguration().getValue() : ""
                            );

                            if (historyTracking.getFollowedFields()) {
                                let followedFields = historyTracking.getFollowedFields();
                                followedFields.forEach((followedField) => {
                                    console.log("Field HistoryTracking FollowedFields APIName:", followedField.getAPIName());
                                    console.log("Field HistoryTracking FollowedFields Id:", followedField.getId());
                                });
                            }
                            ...
                            if (module != null) {
                                ...
                                console.log("Field HistoryTracking Module DisplayLabel" + module.getDisplayLabel());
                                console.log("Field HistoryTracking Module APIName" + module.getAPIName());
                                console.log("Field HistoryTracking Module ID" + module.getId());
                                console.log("Field HistoryTracking Module Module" + module.getModule());
                                console.log("Field HistoryTracking Module ModuleName" + module.getModuleName());
                            }
                            let durationConfigured = historyTracking.getDurationConfiguredField();
                            if (durationConfigured != null) {
                                console.log("Field Historytracking durationConfigured field" + durationConfigured.getId());
                            }
                        }
