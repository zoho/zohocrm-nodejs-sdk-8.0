...
class GetScoringRules {
    ...
    static async getScoringRules() {
        ...
        await paramInstance.add(ZOHOCRMSDK.ScoringRules.GetScoringRulesParam.MODULE, "Leads");
        ...
        if (response != null) {
            ...
            if (responseObject != null) {
                if (responseObject instanceof ZOHOCRMSDK.ScoringRules.ResponseWrapper) {
...
await GetScoringRules.initialize();
