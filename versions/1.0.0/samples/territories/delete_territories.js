...
class DeleteTerritories {
    ...
    static async deleteTerritories() {
        ...
        await paraminstance.add(ZOHOCRMSDK.Territories.DeleteTerritoriesParam.IDS, 32324234232n);
        await paraminstance.add(ZOHOCRMSDK.Territories.DeleteTerritoriesParam.DELETE_PREVIOUS_FORECASTS, false);
        let response = await territoriesOperations.deleteTerritories(paraminstance);
        if (response != null) {
...
await DeleteTerritories.initialize();
