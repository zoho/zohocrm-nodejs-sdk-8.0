...
class UpdateGroup {
    ...
    static async updateGroup(groupId) {
        ...
        let response = userGroupOperations.updateGroup(groupId, request);
        if (response != null) {
...
let groupId = 4300242324003n;
await UpdateGroup.initialize();
await UpdateGroup.updateGroup(groupId);