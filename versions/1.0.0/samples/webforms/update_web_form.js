...
class UpdateWebForm {
    ...
    static async updateWebForm(formId, moduleAPIName) {
        ...
        let response = await webformsOperations.updateWebForm(formId, request);
        if (response != null) {
...
let formId = 32313121n;
await UpdateWebForm.initialize();
await UpdateWebForm.updateWebForm(formId, moduleAPIName);