...
class DeactivateSharingRule{
    ...
    static async deactivateSharingRule(id, moduleAPIName) {
        const sharingRulesOperations = new ZOHOCRMSDK.SharingRules.SharingRulesOperations(moduleAPIName);

        const response = await sharingRulesOperations.deactivateSharingRule(id);
...
await DeactivateSharingRule.initialize();
await DeactivateSharingRule.deactivateSharingRule(id, moduleAPIName);