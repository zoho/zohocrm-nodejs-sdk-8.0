...
class GetEmailTemplatesParam{
	...
	static CATEGORY = new Param("category", "com.zoho.crm.api.EmailTemplates.GetEmailTemplatesParam");
	static SORT_BY = new Param("sort_by", "com.zoho.crm.api.EmailTemplates.GetEmailTemplatesParam");
	static SORT_ORDER = new Param("sort_order", "com.zoho.crm.api.EmailTemplates.GetEmailTemplatesParam");
	static FILTERS = new Param("filters", "com.zoho.crm.api.EmailTemplates.GetEmailTemplatesParam");
}
