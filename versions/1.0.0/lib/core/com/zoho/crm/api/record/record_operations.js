...
class RecordOperations{
	 ...
	 * @throws {SDKException}
	 */
	async getFullDataForRichText(id, paramInstance=null)	{
		if((!(Object.prototype.toString.call(id) == "[object BigInt]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: id EXPECTED TYPE: BigInt", null, null);
		}
		if((paramInstance != null) && (!(paramInstance instanceof ParameterMap)))	{
	 ...
	 * @throws {SDKException}
	 */
	async getRichTextRecords(paramInstance=null)	{
		if((paramInstance != null) && (!(paramInstance instanceof ParameterMap)))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: paramInstance EXPECTED TYPE: ParameterMap", null, null);
		}
		var handlerInstance = new CommonAPIHandler();
...
class SearchRecordsParam{
	...
	static TYPE = new Param("type", "com.zoho.crm.api.Record.SearchRecordsParam");
}
...
class RecordCountParam{
	...
	static CVID = new Param("cvid", "com.zoho.crm.api.Record.RecordCountParam");
...
class GetFullDataForRichTextParam{
	...
	static FIELDS = new Param("fields", "com.zoho.crm.api.Record.GetFullDataForRichTextParam");
}

class GetRichTextRecordsParam{

	static IDS = new Param("ids", "com.zoho.crm.api.Record.GetRichTextRecordsParam");
	static FIELDS = new Param("fields", "com.zoho.crm.api.Record.GetRichTextRecordsParam");
}
