...
class GetRelatedRecordsParam{
	...
	static IDS = new Param("ids", "com.zoho.crm.api.RelatedRecords.GetRelatedRecordsParam");
}
...
class GetRelatedRecordsUsingExternalIDParam{
	...
	static IDS = new Param("ids", "com.zoho.crm.api.RelatedRecords.GetRelatedRecordsUsingExternalIDParam");
}
