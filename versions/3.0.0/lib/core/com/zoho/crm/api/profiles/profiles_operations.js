...
class GetProfilesParam{
	...
	static INCLUDE_LITE_PROFILE = new Param("include_lite_profile", "com.zoho.crm.api.Profiles.GetProfilesParam");
}
...
class DeleteProfileParam{
	...
	static TRANSFER_TO = new Param("transfer_to", "com.zoho.crm.api.Profiles.DeleteProfileParam");
}
