...
class Fields{
	...
	async setOperationType(operationType)	{
		const OperationType = (await (import("./operation_type.js"))).MasterModel;
	...
	async setEmailParser(emailParser)	{
		const EmailParser = (await (import("./email_parser.js"))).MasterModel;
	...
	async setRollupSummary(rollupSummary)	{
		const RollupSummary = (await (import("./rollup_summary.js"))).MasterModel;
	...
	async setReferFromField(referFromField)	{
		const ReferFromField = (await (import("./refer_from_field.js"))).MasterModel;
	...
	async setMultiModuleLookup(multiModuleLookup)	{
		const MultiModuleLookup = (await (import("./multi_module_lookup.js"))).MasterModel;
	...
	async setLookup(lookup)	{
		const Lookup = (await (import("./lookup.js"))).MasterModel;
	...
	async setUnique(unique)	{
		const Unique = (await (import("./unique.js"))).MasterModel;
	...
	async setSubform(subform)	{
		const Subform = (await (import("./subform.js"))).MasterModel;
	...
	async setExternal(external)	{
		const External = (await (import("./external.js"))).MasterModel;
	...
	async setPrivate(private1)	{
		const Private = (await (import("./private.js"))).MasterModel;
	...
	async setMultiselectlookup(multiselectlookup)	{
		const Multiselectlookup = (await (import("./multiselectlookup.js"))).MasterModel;
	 ...
	 */
	async setAutoNumber61(autoNumber61)	{
		const AutoNumber = (await (import("./auto_number.js"))).MasterModel;
		if((autoNumber61 != null) && (!(autoNumber61 instanceof AutoNumber)))	{
	...
	async setTooltip(tooltip)	{
		const Tooltip = (await (import("./tooltip.js"))).MasterModel;
	 ...
	 * @returns {Boolean} A Boolean representing the historyTrackingEnabled
	 */
	 ...
	 * @param {Boolean} historyTrackingEnabled A Boolean representing the historyTrackingEnabled
	 */
	setHistoryTrackingEnabled(historyTrackingEnabled)	{
		if((historyTrackingEnabled != null) && (!(Object.prototype.toString.call(historyTrackingEnabled) == "[object Boolean]")))	{
			throw new SDKException(Constants.DATA_TYPE_ERROR, "KEY: historyTrackingEnabled EXPECTED TYPE: Boolean", null, null);
		}
	...
	async setHistoryTracking(historyTracking)	{
		const HistoryTracking = (await (import("./history_tracking.js"))).MasterModel;
	...
	async setHipaaCompliance(hipaaCompliance)	{
		const HipaaCompliance = (await (import("./hipaa_compliance.js"))).MasterModel;
	...
	async setTextarea(textarea)	{
		const Textarea = (await (import("./textarea.js"))).MasterModel;
