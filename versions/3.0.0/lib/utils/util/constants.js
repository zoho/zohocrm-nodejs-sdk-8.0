class Constants {
    ...
    static DATE_TYPE = "[object Date]";
    static ROLLUP_SUMMARY = "rollup_summary"
    static PRIMITIVE_TYPES = ['string', 'number', 'boolean'];
    static OAUTH_HEADER_PREFIX = "Zoho-oauthtoken ";
    static GENERATE_TOKEN_ID_ERROR = "Exception in generateId() - DBStore";
    static AUTHORIZATION = "Authorization";
    static REVOKE_URL = "/revoke";
    static REFRESH_TOKEN_REMOVED = "Refresh token revoked successfully";
    static TOKEN_NOT_FOUND = " No tokens exist for the given user-id.";
    ...
    static REVOKE_TOKEN_ERROR = "Exception while revoke the refresh token.";
    ...
    static GET_TOKEN_FILE_ERROR1 = "Exception in FileStore : Given user authentication details not found.";
    ...
    static GET_TOKEN_BY_USER_NAME_ERROR = "Exception in getToken() - OAuthToken : Given user_name token details not found, Please give required item";
    ...
    static OAUTH_TOKEN_FIELDS = ["clientID", "clientSecret","refreshToken", "redirectURL", "grantToken", "accessToken", "expiresIn", "userSignature", "id", "apiDomain", "findUser"];
    ...
    static LAYOUT_NAMESPACE = 'core/com/zoho/crm/api/layouts/layouts';
    ...
    static SET_TO_CONTENT_TYPE = ["/crm/bulk/v8/read", "/crm/bulk/v8/write", "/crm/v8/__zia_org_enrichment", "crm/v8/__zia_people_enrichment", "/crm/v8/settings/audit_log_export"];
    ...
    static TIMEZONE_NAMESPACE = "TimeZone";
    static ENVIRONMENT_ERROR_1 = "ENVIRONMENT_ERROR";
    static ENVIRONMENT_ERROR_RESPONSE = "Exception in set the api environment.";
    static API_DOMAIN = "api_domain";
    static US_DATACENTER = ["https://www.zohoapis.com", "https://sandbox.zohoapis.com", "https://developer.zohoapis.com", "https://accounts.zoho.com/oauth/v2/token", "us"];
    static JP_DATACENTER = ["https://www.zohoapis.jp", "https://sandbox.zohoapis.jp", "https://developer.zohoapis.jp", "https://accounts.zoho.jp/oauth/v2/token", "jp"];
    static IN_DATACENTER = ["https://www.zohoapis.in", "https://sandbox.zohoapis.in", "https://developer.zohoapis.in", "https://accounts.zoho.in/oauth/v2/token", "in"];
    static EU_DATACENTER = ["https://www.zohoapis.eu", "https://sandbox.zohoapis.eu", "https://developer.zohoapis.eu", "https://accounts.zoho.eu/oauth/v2/token", "eu"];
    static CN_DATACENTER = ["https://www.zohoapis.com.cn", "https://sandbox.zohoapis.com.cn", "https://developer.zohoapis.com.cn", "https://accounts.zoho.com.cn/oauth/v2/token", "cn"];
    static AU_DATACENTER = ["https://www.zohoapis.com.au", "https://sandbox.zohoapis.com.au", "https://developer.zohoapis.com.au", "https://accounts.zoho.com.au/oauth/v2/token", "au"];
    static CA_DATACENTER = ["https://www.zohoapis.ca", "https://sandbox.zohoapis.ca", "https://developer.zohoapis.ca", "https://accounts.zohocloud.ca/oauth/v2/token", "ca"];
    static SA_DATACENTER = ["https://www.zohoapis.sa", "https://sandbox.zohoapis.sa", "https://developer.zohoapis.sa", "https://accounts.zoho.sa/oauth/v2/token", "sa"]
    static SANDBOX = "sandbox";
    static DEVELOPER = "developer";
    static FIND_USER = "findUser";
    static PARAM_EXCEPTION = "Exception in forming request Parameter : ";
	static HEADER_EXCEPTION = "Exception in forming request Header : ";
    static LOCALTIME_NAMESPACE = "LocalTime";
    static TIME_RANGE_NAMESPACE = "core/com/zoho/crm/api/record/time_range";
	static SUB_TYPE = "sub_type";
    static SUB_TYPE_1 = "sub_type_1";
    static BODY = "body";
    static FUNCTIONS = "v8/functions";
    static FUNCTIONS_PATH = "/actions/execute";
