...
class CreateAccounts {
    ...
    static async createAccounts(moduleAPIName) {
        ...
        parent_account.setId(4402480001389082n);
...
await CreateAccounts.initialize();
await CreateAccounts.createAccounts(moduleAPIName);