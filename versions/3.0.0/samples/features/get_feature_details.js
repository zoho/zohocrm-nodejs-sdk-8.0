...
class GetFeatureDetails {
    ...
    static async getFeatureDetails() {
        ...
        paramInstance.add(ZOHOCRMSDK.Features.GetFeatureDetailsParam.API_NAMES, "data_sharing_rules");
        let response = await featuresOperations.getFeatureDetails(paramInstance);
        if (response != null) {
...
await GetFeatureDetails.initialize();
await GetFeatureDetails.getFeatureDetails();
